...
static unsigned int gpioLED = 48;           ///< Default GPIO for the LED is 60
static unsigned int gpioLED2 = 4;
...
static unsigned int blinkPeriod2 = 2000;
...
static struct task_struct *task, *task2;            // The pointer to the thread task
