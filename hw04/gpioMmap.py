...
print("sw1","{0:b}".format(switch1),"sw2","{0:b}".format(switch2))
...
print("packed_reg1:", end="")
for i in range(len(packed_reg)):
    print("{0:b}".format(packed_reg[i]), end="")
print("\npacked_reg0:",end="")
for i in range(len(packed_reg0)):
    print("{0:b}".format(packed_reg0[i]), end="")
print()
...
print("reg_status1:", "{0:b}".format(reg_status))
print("reg_status0:", "{0:b}".format(reg_status0))
...
try:
  while(True):
    SW1_Status = struct.unpack("<L", mem[GPIO_DATAIN:GPIO_DATAIN+4])[0] & switch1
    SW2_Status = struct.unpack("<L", mem0[GPIO_DATAIN:GPIO_DATAIN+4])[0] & switch2
    print("SW1",  "{0:b}".format(SW1_Status), "SW2", "{0:b}".format(SW2_Status))
